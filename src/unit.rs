...
impl Unit {
    pub(crate) fn from_str(str: &str) -> Option<Unit> {
        match str {
            ...
            "espv" => Some(Unit::SpiritOfVengeance),
            "even" => Some(Unit::AvatarOfVengeance),
            "nqb1" => Some(Unit::Quillbeast1),
            "nqb2" => Some(Unit::Quillbeast2),
            "nqb3" => Some(Unit::Quillbeast3),
            "nqb4" => Some(Unit::Quillbeast4),
            "nwe1" => Some(Unit::Hawk1),
            "nwe2" => Some(Unit::Hawk2),
            "nwe3" => Some(Unit::Hawk3),
            "ncgb" => Some(Unit::ClockwerkGoblin1),
            "ncg1" => Some(Unit::ClockwerkGoblin2),
            "ncg2" => Some(Unit::ClockwerkGoblin3),
            "ncg3" => Some(Unit::ClockwerkGoblin4),
            "ndr1" => Some(Unit::DarkMinion1),
            "ndr2" => Some(Unit::DarkMinion2),
